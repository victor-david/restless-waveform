...
namespace Restless.WaveForm
{
    ...
    public static class Utility
    {
        ...
        public static int GetEvenIntegerValue(int value, int min, int max)
        {
            return Math.Max(Math.Min(GetEvenIntegerValue(value), GetEvenIntegerValue(max)), GetEvenIntegerValue(min));
        }
        ...
        public static int GetEvenIntegerValue(int value)
        {
            if (value % 2 != 0)
            {
                value++;
